...
import os
os.chdir('/Users/michielk/oxdata/P01/EM/Kashturi11')
...
#                                      ...TIME
#                                           so go take a nap.
successes, failures = ocpy.access.get_data(TOKEN, "annotation",
                                x_start=0,              x_stop=bounds[0],
                                y_start=0,              y_stop=bounds[1],
                                z_start=0,              z_stop=bounds[2],
                                resolution=RESOLUTION,location=DATA_LOCATION)
